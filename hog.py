...
def swine_align(player_score, opponent_score):
    ...
    pot_gcd = 1
    final_gcd = 0
    while pot_gcd <= min(player_score, opponent_score):
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        while turn1 == True and score0 < goal and score1 < goal:
            score0 += take_turn(strategy0(score0, score1), score1, dice)
            turn1 = extra_turn(score0, score1)
            say = say(score0, score1)
        who = other(who)
        turn2 = True

        while turn2 == True and score0 < goal and score1 < goal:
            score1 += take_turn(strategy1(score1, score0), score0, dice)
            turn2 = extra_turn(score1, score0)
            say = say(score0, score1)
        who = other(who)
        turn1 = True
    ...
    # BEGIN PROBLEM 6
    # Prob 6 is in the same area as prob 5
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    result=[ ]
    fn = make_averaged(roll_dice)
    
    for i in range (1,11):
        result.append(fn(i, dice))
