...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        u = self.place
        v = 0
        while u != beehive and u != None:
            if rANTdom_else_none(u.bees) and self.min_range <= v <= self.max_range:
                return rANTdom_else_none(u.bees)
            u = u.entrance
            v += 1
        return None
        # END Problem 3 and 4
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        if self.digesting != 0:
            ...
            randbee = rANTdom_else_none(self.place.bees)
            if randbee == None:
                return None
            self.eat_bee(randbee)
